...
public class Ebooks extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        image1= view.findViewById(R.id.y1);
        image2= view.findViewById(R.id.y2);
        image3= view.findViewById(R.id.y3);
        image4= view.findViewById(R.id.y4);
        image5= view.findViewById(R.id.y5);
        image6= view.findViewById(R.id.y6);
        image7= view.findViewById(R.id.y7);
        image8= view.findViewById(R.id.y8);
        image9= view.findViewById(R.id.y9);
        image10= view.findViewById(R.id.y10);
        image11= view.findViewById(R.id.y11);
        image12= view.findViewById(R.id.y12);
        image13= view.findViewById(R.id.y13);
        image14= view.findViewById(R.id.y14);
        image15= view.findViewById(R.id.y15);
        image16= view.findViewById(R.id.y16);
        ...
        if(isNetworkStatusAvialable (getContext())) {
            ...
            RequestQueue obj7= Volley.newRequestQueue(getContext());
            obj7.add(imageRequest7);
            RequestQueue obj8= Volley.newRequestQueue(getContext());
            obj8.add(imageRequest8);
            RequestQueue obj9= Volley.newRequestQueue(getContext());
            obj9.add(imageRequest9);
            RequestQueue obj10= Volley.newRequestQueue(getContext());
            obj10.add(imageRequest10);
            RequestQueue obj11= Volley.newRequestQueue(getContext());
            obj11.add(imageRequest11);
            RequestQueue obj12= Volley.newRequestQueue(getContext());
            obj12.add(imageRequest12);
            RequestQueue obj13= Volley.newRequestQueue(getContext());
            obj13.add(imageRequest13);
            RequestQueue obj14= Volley.newRequestQueue(getContext());
            obj14.add(imageRequest14);
            RequestQueue obj15= Volley.newRequestQueue(getContext());
            obj15.add(imageRequest15);
            RequestQueue obj16= Volley.newRequestQueue(getContext());
